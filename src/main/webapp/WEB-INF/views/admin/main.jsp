...
<head>
  ...
  <meta name="format-detection" content="telephone=no"> 
	...
	<link rel="stylesheet" type="text/css" href="/resources/js/layui/common/global.css">
	<link rel="stylesheet" type="text/css" href="/resources/js/layui/admin/css/main.css" media="all">
</head>
<body>
...
<script type="text/javascript" src="/resources/js/layui/admin/jsplug/echarts.min.js"></script>
<script type="text/javascript" src="/resources/js/layui/admin/js/main.js"></script>
</body>
</html>