...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/js/layui/admin/css/adminstyle.css" media="all">
</head>
<body>
	...
	<div class="layui-header header header-demo">
		<div class="layui-main">
			...
			<div class="admin-logo-box">
				<a class="logo" href="/admin/index.html" title="logo"><img src="/resources/js/layui/common/images/logo.png" alt=""></a>
            ...
            <ul class="layui-nav larry-header-item">
            		<li class="layui-nav-item first">
						<a href="javascript:;">
							<img src="/resources/js/layui/admin/images/userimg.jpg" class="userimg">			
							<cite>默认站点</cite>
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<div class="user-photo">
			<a class="img" title="我的头像" >
				<img src="/resources/js/layui/admin/images/user.jpg" class="userimg1"></a>
			<p>你好！admin, 欢迎登录</p>
		</div>
		<!-- 左侧菜单 -->
			...
			<li class="layui-nav-item">
					<a href="javascript:;">
					   ...
					   <em class="layui-nav-more"></em>
					    ...
					    <dl class="layui-nav-child">
					    	<dd>
					    		<a href="javascript:;" data-url="/admin/user/initUI.html">
...
<!-- 加载js文件-->
	...
	<script type="text/javascript" src="/resources/js/layui/admin/js/larry.js"></script>
	<script type="text/javascript" src="/resources/js/layui/admin/js/index.js"></script>
<!-- 锁屏 -->
<div class="lock-screen" style="display: none;">
	<div id="locker" class="lock-wrapper">
		<div id="time"></div>
		<div class="lock-box center">
			<img src="/resources/js/layui/admin/images/userimg.jpg" alt="">
			<h1>admin</h1>
